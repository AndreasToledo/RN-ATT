...
export default function App() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Image source={{uri:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXbCSXHhQiMmnleXW3CaAMyWFlvglf8F8TYw&s"}} style={{width:300, height:200, marginBottom:20, marginTop:40, borderRadius: 20, alignSelf: 'center'}}
      />
